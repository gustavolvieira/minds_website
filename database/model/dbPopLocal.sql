...
INSERT INTO `project` VALUES (1,'Data Visualization in Many Objective Optimization Problems (MaOPs)','<p>Data Visualization in high-dimensional spaces is a great challenge and an important tool for decision-making.  The method of Aggregation Trees was an important step in visualization in MaOPs, allowing a greater understanding of the problem. This method is based on the sequential aggregation of objectives, which is visually represented into a tree, based on a measure of conflict between pairs of (groups of) objectives. The method allows the visualization of a hierarchy for aggregation of the objectives, with possibility to create new constraints for the problem or reduce the number of objectives in a further analysis (Silva2016).</p>\r <p>In the paper “A New Visualization Method in Many-Objective Optimization with Chord Diagram and Angular Mapping” (https://doi.org/10.1016/j.knosys.2017.09.035), the authors present a new method able to display high dimensional data. With the proposed method it is possible to represent more than one data set in a single two-dimensional graphic representation. The two methods presented (Chord Diagram and Angular Mapping), it is possible to observe the existence of conflict and harmony between objectives, as well as the formation of clusters, convergence and dispersion of points. It is also possible recognize the geometric format of each set of points.</p>\r <p>In the Chord Diagram, the range of each coordinate is normalized and arranged in a circle and the coordinate values are connected by means of Bezier curves. </p>\r <p>In the Angular Mapping, each point is seen as a vector and three features are collected of each vector: The Euclidean norm ρ, the smallest angle θ between the vector and the canonical basis and in which vector j of the canonical base this smallest angle occurs. With these three values, it is possible to observe the distribution of points in space, its angular proximity to each axis and its proximity to the origin of the Cartesian coordinate system.</p>\r <p>In another paper called “Information to the Eye of the Beholder: Data Visualization for Many-Objective Optimization”, the authors combine the Chord Diagram, Angular Mapping and the Parallel Coordinates in a single two dimensional circular chart. An R script of this method is available in the download area of the MINDS website.</p>\r ','2014-12-01 00:00:00',NULL,'2018-03-28 00:00:00','2018-03-28 00:00:00',1),(2,'pyFTS - Fuzzy Time Series for Python','<p>Python library for Fuzzy Time Series</p> <iframe src=\"https://petroniocandido.github.io/pyFTS/\" frameborder=0 scrolling=auto width=100% height=3300></iframe> ','2016-12-01 00:00:00',NULL,'2018-08-03 00:00:00','2018-08-03 00:00:00',1);
...
INSERT INTO `project_image` VALUES (1,'Chord Diagram for a 12 objective Optimization problem',1,'images/projects_images/project_1/Chord_01.png',1),(2,'Chord Diagram for a 3 objective Optimization problem',2,'images/projects_images/project_1/Chord_02.png',1),(3,'Angular Mapping for points in five dimensional space',3,'images/projects_images/project_1/3.png',1),(4,'Integrated Visualization Tool for a 5 objective optimization problem',4,'images/projects_images/project_1/4.png',1),(5,'Integrated Visualization Tool for a 5 objective optimization problem',5,'images/projects_images/project_1/5.png',1),(6,'Integrated Visualization Tool for a 10 objective optimization problem',6,'images/projects_images/project_1/6.png',1);
...
INSERT INTO `project_user` VALUES (1,1,3),(1,7,2),(1,23,1),(2,3,1);
...
INSERT INTO `user_post` VALUES (1,1),(3,2),(1,3),(1,4);
...
-- Dump completed on 2018-08-03 14:40:43
